...
The application uses a Flask backend and a web-based frontend, with  Open-Meteo, OpenStreetMap for location/map features and Google Gemini for the AI weather assistant.
